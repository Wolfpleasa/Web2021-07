...
export default {
  ...
  watch: {
      ...
      if (me.formMode == 1) {
        ...
        axios
          ...
          .then((res) => {
            ...
            me.employee.Salary = CommonFn.formatMoney(res.data.Salary);
            me.employee.DateOfBirth = CommonFn.convertDate(
              res.data.DateOfBirth
            );
            me.employee.JoinDate = CommonFn.convertDate(res.data.JoinDate);
    ...
    response: function () {
      ...
      if (responseMess == "Lưu") {
        me.employee.Salary = CommonFn.formatNumber(me.employee.Salary);
        //Thêm nhân viên mới
        if (me.formMode == 0) {
          axios
  ...
  methods: {
    ...
    /**
     * Hàm kiểm tra các dropdown đã được chọn chưa
     * Ngọc 23/8/2021
     */
    validateDropdown() {
      let me = this;
    ...
    convertMoney() {
      ...
      me.employee.Salary = CommonFn.formatMoney(val1);
    },
